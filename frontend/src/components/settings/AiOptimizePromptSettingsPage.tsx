...
export function AiOptimizePromptSettingsPage() {
  ...
  return (
    <div>
      <h2 className="settings-page-title">{t('settingsPage.aiOptimizePageTitle')}</h2>
      <p className="settings-page-desc">{t('settingsPage.aiOptimizePageDesc')}</p>
      <hr className="settings-page-divider" />

      <div className="settings-field-group-title">{t('settingsPage.aiOptimizeSection')}</div>
      <div className="settings-field-group">
        {loading ? (
          ...
          <div className="settings-form">
            ...
            >
              {isDefault
                ? t('settingsPage.aiOptimizeRemarkDefault')
                : t('settingsPage.aiOptimizeRemarkCustom')}
            </div>
