  ...
  return (
    <div className="web-browser-preview">
      <div className="browser-toolbar">
        <button type="button" className="browser-nav-btn" onClick={goBack} title="后退">
          <svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            <polyline points="10 4 6 8 10 12" />
          </svg>
        </button>
        <button type="button" className="browser-nav-btn" onClick={goForward} title="前进">
          <svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            <polyline points="6 4 10 8 6 12" />
          </svg>
        </button>
        <button type="button" className="browser-nav-btn" onClick={refresh} title="刷新">
        ...
        <div className="browser-url-bar">
          ...
          />
          <button type="button" className="browser-go-btn" onClick={navigate} title="前往">
        ...
        <button type="button" className="browser-open-btn" onClick={openExternal} title="在系统浏览器中打开">
      ...
      {isPlaceholder ? (
        <div className="browser-placeholder">
          <div className="browser-placeholder-content">
            ...
            <span className="browser-placeholder-text">在地址栏输入网址开始浏览</span>
          </div>
        </div>
      ) : null}
      <iframe
